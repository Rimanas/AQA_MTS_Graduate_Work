...
public class MilestonesPage: BasePage
{
    ...
    private static readonly By ErrorAddMilestoneTextBy = By.CssSelector("[class='message message-error']");
    ...
    private static readonly By MilestoneNameBy = By.XPath("//*[@class='summary-title text-ppp']//a");
    ...
    public IWebElement ErrorAddMilestoneText => WaitsHelper.WaitForExists(ErrorAddMilestoneTextBy);
    ...
    public ReadOnlyCollection<IWebElement> MilestoneName => WaitsHelper.WaitForAllVisibleElementsLocatedBy(MilestoneNameBy);
    ...
    public string GetErrorAddMilestoneLabel() => ErrorAddMilestoneText.Text.Trim();
